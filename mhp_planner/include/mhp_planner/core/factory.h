...
#ifndef SRC_CORE_INCLUDE_MHP_PLANNER_CORE_FACTORY_H_
#define SRC_CORE_INCLUDE_MHP_PLANNER_CORE_FACTORY_H_
...
#endif  // SRC_CORE_INCLUDE_MHP_PLANNER_CORE_FACTORY_H_
