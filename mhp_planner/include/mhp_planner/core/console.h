...
#ifndef SRC_CORE_INCLUDE_MHP_PLANNER_CORE_CONSOLE_H_
#define SRC_CORE_INCLUDE_MHP_PLANNER_CORE_CONSOLE_H_

#include <mhp_planner/core/text_style.h>
#include <string>

// === Colors ===

#define WARNING_COLOR mhp_planner::TextColorCode::FG_LIGHT_YELLOW
#define ERROR_COLOR mhp_planner::TextColorCode::FG_LIGHT_RED
#define DEFAULT_COLOR mhp_planner::TextColorCode::FG_DEFAULT

// ==== Function name ===

#if defined(__GNUC__)
#define MHP_PLANNER_FUNCTION_NAME __PRETTY_FUNCTION__
#elif defined(_MSC_VER)
#define MHP_PLANNER_FUNCTION_NAME __FUNCSIG__
#else
#define MHP_PLANNER_FUNCTION_NAME __FUNCTION__
#endif

#define MHP_PLANNER_FUNCTION_NAME_FORMATTED "[" << MHP_PLANNER_FUNCTION_NAME << "] "
...
#define PRINT_DEBUG_NAMED(msg) PRINT_DEBUG(MHP_PLANNER_FUNCTION_NAME_FORMATTED << msg)
#define PRINT_DEBUG_ONCE_NAMED(msg) PRINT_DEBUG_ONCE(MHP_PLANNER_FUNCTION_NAME_FORMATTED << msg)
#define PRINT_DEBUG_COND_NAMED(cond, msg) PRINT_DEBUG_COND(cond, MHP_PLANNER_FUNCTION_NAME_FORMATTED << msg)
#define PRINT_DEBUG_COND_ONCE_NAMED(cond, msg) PRINT_DEBUG_COND_ONCE(cond, MHP_PLANNER_FUNCTION_NAME_FORMATTED << msg)

#define PRINT_INFO_NAMED(msg) PRINT_INFO(MHP_PLANNER_FUNCTION_NAME_FORMATTED << msg)
#define PRINT_INFO_ONCE_NAMED(msg) PRINT_INFO_ONCE(MHP_PLANNER_FUNCTION_NAME_FORMATTED << msg)
#define PRINT_INFO_COND_NAMED(cond, msg) PRINT_INFO_COND(cond, MHP_PLANNER_FUNCTION_NAME_FORMATTED << msg)
#define PRINT_INFO_COND_ONCE_NAMED(cond, msg) PRINT_INFO_COND_ONCE(cond, MHP_PLANNER_FUNCTION_NAME_FORMATTED << msg)

#define PRINT_WARNING_NAMED(msg) PRINT_WARNING(MHP_PLANNER_FUNCTION_NAME_FORMATTED << msg)
#define PRINT_WARNING_ONCE_NAMED(msg) PRINT_WARNING_ONCE(MHP_PLANNER_FUNCTION_NAME_FORMATTED << msg)
#define PRINT_WARNING_COND_NAMED(cond, msg) PRINT_WARNING_COND(cond, MHP_PLANNER_FUNCTION_NAME_FORMATTED << msg)
#define PRINT_WARNING_COND_ONCE_NAMED(cond, msg) PRINT_WARNING_COND_ONCE(cond, MHP_PLANNER_FUNCTION_NAME_FORMATTED << msg)

#define PRINT_ERROR_NAMED(msg) PRINT_ERROR(MHP_PLANNER_FUNCTION_NAME_FORMATTED << msg)
#define PRINT_ERROR_ONCE_NAMED(msg) PRINT_ERROR_ONCE(MHP_PLANNER_FUNCTION_NAME_FORMATTED << msg)
#define PRINT_ERROR_COND_NAMED(cond, msg) PRINT_ERROR_COND(cond, MHP_PLANNER_FUNCTION_NAME_FORMATTED << msg)
#define PRINT_ERROR_COND_ONCE_NAMED(cond, msg) PRINT_ERROR_COND_ONCE(cond, MHP_PLANNER_FUNCTION_NAME_FORMATTED << msg)

#define PRINT_FATAL_NAMED(msg) PRINT_FATAL(MHP_PLANNER_FUNCTION_NAME_FORMATTED << msg)

#endif  // SRC_CORE_INCLUDE_MHP_PLANNER_CORE_CONSOLE_H_
