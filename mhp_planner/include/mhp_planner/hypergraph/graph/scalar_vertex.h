...
#ifndef SRC_OPTIMIZATION_INCLUDE_MHP_PLANNER_OPTIMIZATION_HYPER_GRAPH_SCALAR_VERTEX_H_
#define SRC_OPTIMIZATION_INCLUDE_MHP_PLANNER_OPTIMIZATION_HYPER_GRAPH_SCALAR_VERTEX_H_
...
class ScalarVertex : public VertexInterface
{
 public:
    ...
    explicit ScalarVertex(double value) : _value(value), _lb(-MHP_PLANNER_INF_DBL), _ub(MHP_PLANNER_INF_DBL) {}

    //! Construct vertex with given value and fixed flag
    explicit ScalarVertex(double value, bool fixed) : _value(value), _lb(-MHP_PLANNER_INF_DBL), _ub(MHP_PLANNER_INF_DBL), _fixed(fixed) {}
    ...
    // implements interface method
    bool hasFiniteBounds() const override { return _lb > -MHP_PLANNER_INF_DBL || _ub < MHP_PLANNER_INF_DBL; }
    // implements interface method
    bool hasFiniteLowerBounds() const override { return _lb > -MHP_PLANNER_INF_DBL; }
    // implements interface method
    bool hasFiniteUpperBounds() const override { return _ub < MHP_PLANNER_INF_DBL; }
    // implements interface method
    bool hasFiniteLowerBound(int /*idx*/) const override { return _lb > -MHP_PLANNER_INF_DBL; }
    // implements interface method
    bool hasFiniteUpperBound(int /*idx*/) const override { return _ub < MHP_PLANNER_INF_DBL; }
    // implements interface method
...
#endif  // SRC_OPTIMIZATION_INCLUDE_MHP_PLANNER_OPTIMIZATION_HYPER_GRAPH_SCALAR_VERTEX_H_
