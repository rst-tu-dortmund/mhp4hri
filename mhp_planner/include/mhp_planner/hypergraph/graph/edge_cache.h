...
#ifndef SRC_OPTIMIZATION_INCLUDE_MHP_PLANNER_OPTIMIZATION_HYPER_GRAPH_EDGE_CACHE_H_
#define SRC_OPTIMIZATION_INCLUDE_MHP_PLANNER_OPTIMIZATION_HYPER_GRAPH_EDGE_CACHE_H_
...
class EdgeCache
{
 public:
    ...
    Eigen::VectorXd& pushValues(int value_dim)
    {
        ...
        return _values.emplace_back(value_dim);
#else
...
#endif  // SRC_OPTIMIZATION_INCLUDE_MHP_PLANNER_OPTIMIZATION_HYPER_GRAPH_EDGE_CACHE_H_
