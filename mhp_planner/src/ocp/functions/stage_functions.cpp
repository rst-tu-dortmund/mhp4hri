...
std::unordered_map<std::string, int> StageFunctionCounter::counts = {};

void StageFunctionCounter::setZero()
{
    for (auto& e : counts)
    {
        e.second = 0;
...
void StageFunctionCounter::inc(const std::string& type)
{
...
void StageFunctionCounter::print()
{
    std::cout << "Stage Function Calls: " << std::endl;
    for (const std::pair<std::string, int>& e : counts)
    {
