...
#include <mhp_planner/hypergraph/graph/hyper_graph.h>
...
//            if (vertex->getLowerBounds()[i] > -MHP_PLANNER_INF_DBL || vertex->getUpperBounds()[i] < MHP_PLANNER_INF_DBL)
//            {
...
//            if (vertex->getLowerBounds()[i] > -MHP_PLANNER_INF_DBL)
//            {
//                ++_dim_finite_bounds;
//                ++_dim_finite_combined_bounds;
//                if (vertex->getUpperBounds()[i] < MHP_PLANNER_INF_DBL) ++_dim_finite_bounds;
//            }
//            else if (vertex->getUpperBounds()[i] < MHP_PLANNER_INF_DBL)
//            {
//                ++_dim_finite_bounds;
//                ++_dim_finite_combined_bounds;
//            }
...
//{
//    if (_vertices.empty()) return -MHP_PLANNER_INF_DBL;
...
//{
//    if (_vertices.empty()) return MHP_PLANNER_MAX_DBL;
