...
// See https://gitlab.com/libeigen/eigen/-/merge_requests/716/diffs and https://eigen.tuxfamily.org/dox-devel/DisableStupidWarnings_8h_source.html
#if defined __NVCC__
...
// Disable the "calling a __host__ function from a __host__ __device__ function is not allowed" messages (yes, there are many of them and they seem to
// change with every version of the compiler)
